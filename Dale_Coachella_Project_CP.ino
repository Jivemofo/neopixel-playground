...
const int minBrightness = 10; //defines the lowest brightness level from 0-255, low starting point is more pleasing
...
currentBrightness = 10;        // keeps track of the current color that is displayed for fading purposes
